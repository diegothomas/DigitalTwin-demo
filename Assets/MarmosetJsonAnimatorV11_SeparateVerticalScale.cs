...
/*
 * MarmosetJsonAnimatorV11_SeparateVerticalScale
 *
 * Purpose:
 ...
 */
public class MarmosetJsonAnimatorV11_SeparateVerticalScale : MonoBehaviour
{
    [Header("Input")]
    ...
    public void Initialize()
    {
        ...
        if (logOnStart)
        {
            Debug.Log("Marmoset V11 loaded. frames=" + anim.frames.Length +
                " fps=" + fps +
